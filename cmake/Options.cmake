...
if(WIN32)
	if ( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
		...
		set(PATCH_CMD ${CMAKE_CURRENT_SOURCE_DIR}/mingw/mingw32/msys/1.0/bin/patch.exe)
	endif()
	set(LIBEXT ".lib")
	set(LIBPREFIX "")
	...
	if ( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
		set(MINGW_PATH ${CMAKE_CURRENT_SOURCE_DIR}/mingw/mingw64)
		set(MINGW_SHELL ming64sh.cmd )
		set(PERL_SHELL ${CMAKE_CURRENT_SOURCE_DIR}/perl/portableshell.bat )
		set(MINGW_HOST x86_64-w64-mingw32)
    else()
		set(MINGW_PATH ${CMAKE_CURRENT_SOURCE_DIR}/mingw/mingw32)
		set(MINGW_SHELL ming32sh.cmd )
		set(PERL_SHELL ${CMAKE_CURRENT_SOURCE_DIR}/perl32/portableshell.bat )
	...
	set(CONFIGURE_BUILD_TARGET ${PLATFORM_BUILD_TARGET})
endif()
