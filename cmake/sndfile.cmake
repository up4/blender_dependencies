...
ExternalProject_Add(external_sndfile
  ...
  CONFIGURE_COMMAND ${CONFIGURE_ENV} && cd ${CMAKE_CURRENT_BINARY_DIR}/build/sndfile/src/external_sndfile/ && ${SNDFILE_ENV} sh ./configure ${CONFIGURE_BUILD_TARGET} --enable-static --prefix=${mingw_LIBDIR}/sndfile
...
add_dependencies(external_sndfile external_ogg external_vorbis external_flac)
